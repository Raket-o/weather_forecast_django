...
# def cities_list_view(request) -> HttpResponseRedirect:
...
class CityFormView(UserPassesTestMixin, CreateView):
    ...
    def form_valid(self, form) -> None:
        ...
        # return self.request
        # return response
        # return redirect('cities_list', pk=employee.pk)
        # return redirect('forecast:cities_list_view', context={'cities_list': cities_list})
        # return redirect('forecast:cities_list_view', context={"cities_list": cities_list})
        # return redirect('cities_list_view')
        # return reverse_lazy("forecast:cities_list_view")
        # return render(response, template_name="forecast/cities_list.html", context={"cities_list": cities_list})
